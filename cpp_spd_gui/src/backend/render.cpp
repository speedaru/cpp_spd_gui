...
void CreateRenderTarget(spd::backend::DxData& dxData);
void CleanupRenderTarget(spd::backend::DxData& dxData);
...
void CleanupRenderTarget(spd::backend::DxData& renderData) {
